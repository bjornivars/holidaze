        ...
        <div className=" [ promotion d-flex jc-between col-9 col-t-11 ] ">
            <div className=" [ promotion-box col-3 col-t-3 ] ">
                ...
                <div className=" [ promotion-box-text ] ">
                    ...
                    <a href="https://placeholder.com/" target="_blank" rel="noopener noreferrer" className=" [ link ] ">Check our travel suggestions!</a>
                </div>
            </div>
            <div className=" [ promotion-box col-3 col-t-3 ] ">
                ...
                <div className=" [ promotion-box-text ] ">
                    ...
                    <a href="https://placeholder.com/" target="_blank" rel="noopener noreferrer" className=" [ link ] ">Check our flights!</a>
                </div>
            </div>
            <div className=" [ promotion-box col-3 col-t-3 ] ">
                ...
                <div className=" [ promotion-box-text ] ">
                    ...
                    <a href="https://placeholder.com/" target="_blank" rel="noopener noreferrer" className=" [ link ] ">Check our rental cars!</a>
                </div>
            </div>
        </div>
    );
